...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="form">
            <form method="POST">
                <input type="email" name="Login" class="input-email" placeholder="E-mail" required>
            ...
            <p><a href="<?php echo INCLUIR_PATH ?>Registrar">Criar conta</a></p>
        </div>
